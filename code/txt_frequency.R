...
analyze_frequency <- function(tokens_df, output_dir, plots_dir) {
  ...
  save_plot_to_pdf(top_10_plot_doc, file.path(plots_document_dir, "most_frequent_words.pdf"))
  ...
  save_plot_to_pdf(top_10_plot_site, file.path(plots_site_dir, "most_frequent_words.pdf"))
...
save_plot_to_pdf(term_frequency_doc, file.path(plots_document_dir, "term_frequency.pdf"))

  term_frequency_site <- plot_term_frequency(
    docs_words_site,
    group_var = "site",
    title = "Term frequency distribution by site",
    xlab = "Term frequency n/total",
    ylab = "Count"
  )
...
save_plot_to_pdf(term_frequency_site, file.path(plots_site_dir, "term_frequency.pdf"))
  ...
  save_plot_to_pdf(tf_idf_site, file.path(plots_site_dir, "tf_idf.pdf"))
  ...
  write.table(top_words_site, file = file.path(output_dir, "top_words_by_site.tsv"),
    row.names = FALSE, sep = "\t", quote = FALSE)
